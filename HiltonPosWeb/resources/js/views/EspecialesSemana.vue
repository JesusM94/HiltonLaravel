<template>
	<main class="main">
        <div class="container-fluid col-md-10">
            ...
            <div class="card" v-show="!detalle">
                <div class="card-header">
                    <h1><i class="fas fa-star" style="color:purple;"></i> Especiales de la Semana</h1>
                </div>
                <div class="card-body">
        ...
        <!-- Modal Detalle -->
        <detalleperfume v-show="mostrar" :precioMXN="precio_pesos" :detalle_perfume="contenido_perfume" />
        <!-- Fin Modal Detalle -->
