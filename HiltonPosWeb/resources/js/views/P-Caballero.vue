        ...
        <div class="container-fluid col-md-10">
            ...
            <div class="card" v-show="!detalle">
                <div class="card-header">
                    <h1><i class="fa fa-smoking" style="color:brown;"></i> Perfumes de Caballero</h1>
                </div>
                <div class="card-body">
                    <v-client-table :data="tableData" :columns="columns" :options="options">
                        ...
                        <template slot="id" slot-scope="props">
                            ...
                            <div class="d-flex justify-content-center">
                                <button type="button" class="btn btn-outline-primary btn-rounded waves-effect" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false" @click="abrirModal('pdama','detalles',props.row)">
