...
class DiversosController extends Controller
{
    ...
    public function index()
    {
        if (Auth::check())
        {
            $p_diversos = DB::table('tbl_designers AS t3')
                ...
                ->select(
                    ...
                    't2.id AS id_perfume',
                    't2.nombre AS nombre',
                    DB::raw("(CASE WHEN t2.sexo='D' THEN 'Diversos' END) as sexo"),
                    DB::raw("(CASE WHEN t2.contenido='0' THEN 'No Disonible' END) as contenido"),
            ...
            return response()->json($p_diversos);
        }
        else
        {
